...
def ransac_pose_estimation(src_pcd, tgt_pcd, corrs, distance_threshold=0.05, ransac_n=3, iteration=1000):
    ...
    result_ransac = o3d.pipelines.registration.registration_ransac_based_on_correspondence(
        ...
        ransac_n=ransac_n,
        criteria=o3d.pipelines.registration.RANSACConvergenceCriteria(iteration, iteration))
